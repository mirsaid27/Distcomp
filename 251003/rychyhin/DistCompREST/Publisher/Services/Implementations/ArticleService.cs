...
public class Newservice : INewservice
{
    ...
    public Newservice(INewsRepository newsRepository, IEditorRepository editorRepository,
    ...
    public async Task<IEnumerable<NewsResponseDTO>> GetStoriesAsync()
    {
    ...
    public async Task<NewsResponseDTO> CreateNewsAsync(NewsRequestDTO news)
    {
        ...
        newsToCreate.EditorId = news.EditorId;
    ...
    public async Task<NewsResponseDTO> UpdateNewsAsync(NewsRequestDTO news)
    {
        ...
        newsToUpdate.Created = DateTime.UtcNow;
