...
import { MarkerRequestTo, MarkerResponseTo } from '../dtos/marker.dto';
...
describe('MarkerController', () => {
    ...
    let mockMarkerService: jest.Mocked<MarkerService>;
    let mockRequest: Partial<Request>;
    let mockResponse: Partial<Response>;
    let responseObject: any;

    beforeEach(() => {
        mockMarkerService = new MarkerService() as jest.Mocked<MarkerService>;
    ...
    describe('create', () => {
        it('should create a marker and return 201 status', async () => {
            const markerDto: MarkerRequestTo = {
                name: 'Marker 1',
            };
            const markerResponse: MarkerResponseTo = {
                id: 1,
                name: 'Marker 1',
            };
            ...
            await markerController.create(mockRequest as Request, mockResponse as Response);
    ...
    describe('findAll', () => {
        it('should return all markers and return 200 status', async () => {
            const markers: MarkerResponseTo[] = [
                {
                    id: 1,
                    name: 'Marker 1',
                },
            ...
            await markerController.findAll(mockRequest as Request, mockResponse as Response);
    ...
    describe('findById', () => {
        it('should return a marker if found and return 200 status', async () => {
            ...
            await markerController.findById(mockRequest as Request, mockResponse as Response);
    ...
    describe('update', () => {
        it('should update a marker and return 200 status', async () => {
            ...
            await markerController.update(mockRequest as Request, mockResponse as Response);
    ...
    describe('delete', () => {
        it('should delete a marker and return 204 status', async () => {
            ...
            await markerController.delete(mockRequest as Request, mockResponse as Response);
