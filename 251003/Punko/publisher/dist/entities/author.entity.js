...
let Author = (() => {
    let _classDecorators = [Entity('tbl_author')];
    ...
    var Author = _classThis = class {
        constructor() {
            ...
            this.issues = (__runInitializers(this, _lastname_extraInitializers), __runInitializers(this, _issues_initializers, void 0));
    ...
    (() => {
        ...
        _issues_decorators = [OneToMany(() => Issue, (issue) => issue.author)];
