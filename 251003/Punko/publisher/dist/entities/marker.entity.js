...
let Marker = (() => {
    let _classDecorators = [Entity('tbl_marker')];
    ...
    var Marker = _classThis = class {
        constructor() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.name = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _name_initializers, void 0));
            this.issues = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _issues_initializers, void 0));
            __runInitializers(this, _issues_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Marker");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [PrimaryGeneratedColumn()];
        _name_decorators = [Column({ length: 64 })];
        _issues_decorators = [ManyToMany(() => Issue, (issue) => issue.markers)];
        ...
        Marker = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Marker = _classThis;
})();
export { Marker };
