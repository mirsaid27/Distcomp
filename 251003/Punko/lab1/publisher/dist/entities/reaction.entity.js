...
let Reaction = (() => {
    let _classDecorators = [Entity('tbl_reaction')];
    ...
    var Reaction = _classThis = class {
        constructor() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.content = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _content_initializers, void 0));
            this.issue = (__runInitializers(this, _content_extraInitializers), __runInitializers(this, _issue_initializers, void 0));
            __runInitializers(this, _issue_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Reaction");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [PrimaryGeneratedColumn()];
        _content_decorators = [Column()];
        _issue_decorators = [ManyToOne(() => Issue, (issue) => issue.reactions)];
        ...
        Reaction = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Reaction = _classThis;
})();
export { Reaction };
