...
public class CommentServiceImpl implements CommentService {
    ...
    protected void receivePostChange(CommentActionDto commentActionDto) {
    ...
    protected CommentActionDto sendPostAction(CommentActionDto commentActionDto) {
    ...
    public CommentResponseDto create(@NonNull CommentRequestDto dto) throws ServiceException {
        ...
        CommentActionDto action = sendPostAction(CommentActionDto.builder().
    ...
    public List<CommentResponseDto> readAll() {
        return (List<CommentResponseDto>) ((List)sendPostAction(CommentActionDto.builder().
