...
import by.bsuir.publisherservice.service.TagService;
...
@RequestMapping("/tags")
public class TagController extends by.bsuir.publisherservice.controller.RestController {
    ...
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    public List<TagResponseTo> getAll(@RequestParam(name = "page", defaultValue = "0")
                                      Integer pageNumber,
