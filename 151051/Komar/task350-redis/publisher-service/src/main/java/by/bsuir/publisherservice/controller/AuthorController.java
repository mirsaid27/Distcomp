...
import by.bsuir.publisherservice.service.AuthorService;
...
public class AuthorController extends by.bsuir.publisherservice.controller.RestController {
    ...
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    public List<AuthorResponseTo> getAll(@RequestParam(name = "page", defaultValue = "0")
                                         Integer pageNumber,
