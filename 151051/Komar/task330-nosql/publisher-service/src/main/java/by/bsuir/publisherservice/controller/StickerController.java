...
import by.bsuir.publisherservice.service.StickerService;
...
public class StickerController extends by.bsuir.publisherservice.controller.RestController {
    ...
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    public List<StickerResponseTo> getAll(@RequestParam(name = "page", defaultValue = "0")
                                      Integer pageNumber,
