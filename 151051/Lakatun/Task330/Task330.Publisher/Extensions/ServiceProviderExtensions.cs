...
using Task330.Publisher.HttpClients.Implementations;
using Task330.Publisher.HttpClients.Interfaces;
using Task330.Publisher.Infrastructure.Mapper;
using Task330.Publisher.Infrastructure.Validators;
using Task330.Publisher.Repositories.Implementations;
using Task330.Publisher.Repositories.Interfaces;
using Task330.Publisher.Services.Implementations;
using Task330.Publisher.Services.Interfaces;
using Microsoft.EntityFrameworkCore;

namespace Task330.Publisher.Extensions;
