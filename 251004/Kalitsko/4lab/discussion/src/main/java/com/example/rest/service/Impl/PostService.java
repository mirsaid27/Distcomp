...
public class PostService {
    ...
    public PostService(PostRepository postRepository, KafkaTemplate<String, Post> kafkaTemplate, PostMapper postMapper) {
        this.postRepository = postRepository;
        this.kafkaTemplate = kafkaTemplate;
        this.postMapper = postMapper;
    }

    public void sendPostToModeration(Post post) {
        kafkaTemplate.send("OutTopic", post);
    }
