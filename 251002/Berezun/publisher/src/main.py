...
from src.api.v1 import creators, news, reactions, marks
from src.db.db import engine, Base
from src.models.models import Creator, News, Reaction, Mark
...
app.include_router(news.router, prefix="/api/v1.0", tags=["News"])
app.include_router(reactions.router, prefix="/api/v1.0", tags=["Reactions"])
app.include_router(marks.router, prefix="/api/v1.0", tags=["Marks"])
