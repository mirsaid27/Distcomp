...
let Mark = (() => {
    let _classDecorators = [Entity('tbl_mark')];
    ...
    var Mark = _classThis = class {
        constructor() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.name = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _name_initializers, void 0));
            this.articles = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _articles_initializers, void 0));
            __runInitializers(this, _articles_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Mark");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [PrimaryGeneratedColumn()];
        _name_decorators = [Column({ length: 64 })];
        _articles_decorators = [ManyToMany(() => Article, (article) => article.marks)];
        ...
        Mark = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Mark = _classThis;
})();
export { Mark };
