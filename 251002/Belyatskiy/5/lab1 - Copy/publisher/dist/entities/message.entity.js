...
let Message = (() => {
    let _classDecorators = [Entity('tbl_message')];
    ...
    var Message = _classThis = class {
        constructor() {
            ...
            this.article = (__runInitializers(this, _content_extraInitializers), __runInitializers(this, _article_initializers, void 0));
    ...
    (() => {
        ...
        _article_decorators = [ManyToOne(() => Article, (article) => article.messages)];
